    ...
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700 pb-12">
            ...
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-5 relative z-10 p-6 sm:p-8 rounded-[32px] bg-white/40 dark:bg-slate-900/40 backdrop-blur-xl border border-white/60 dark:border-white/5 shadow-2xl shadow-primary/5">
                ...
                <div className="px-4 py-1.5 bg-primary/10 text-primary rounded-full text-[10px] font-black uppercase tracking-[0.2em] border border-primary/20 w-fit">
                    Mentor Profile
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-1 space-y-6">
                    <div className="glass p-8 rounded-2xl border border-white/40 dark:border-slate-800/50 text-center space-y-6 relative overflow-hidden group shadow-xl shadow-slate-200/50 dark:shadow-none">
                        ...
                        <div className="w-24 h-24 rounded-2xl bg-white dark:bg-slate-800 mx-auto flex items-center justify-center text-primary text-3xl font-black shadow-xl ring-4 ring-white dark:ring-slate-900 group-hover:rotate-3 transition-transform">
                            {mentor.full_name?.charAt(0).toUpperCase()}
                        </div>

                        <div className="space-y-1">
                            <h1 className="text-2xl font-black text-slate-900 dark:text-white tracking-tight">{mentor.full_name}</h1>
                        ...
                        <div className="pt-6 border-t border-slate-100 dark:border-white/5 space-y-4">
                            ...
                            {(mentor.employee_id || mentor.student_id) && (
                                <div className="flex items-center gap-3 px-4 py-3 rounded-2xl bg-slate-50 dark:bg-slate-800/40 text-left hover:bg-primary/5 transition-colors">
                                    ...
                                    <div className="min-w-0 flex-1">
                                        <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Mentor ID</p>
                    ...
                    <div className="glass p-8 sm:p-10 rounded-2xl border border-white/40 dark:border-slate-800/50 space-y-8">
                        ...
                        <div className="space-y-4">
                            ...
                            <p className="text-sm sm:text-base text-slate-600 dark:text-slate-400 leading-relaxed font-medium">
                                {mentor.bio || `${mentor.designation || 'Mentor'} ${mentor.full_name} is a dedicated mentor at NEXUS helping mentees achieve their academic and professional goals.`}
                            </p>
                            {mentor.designation && (
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div className="p-6 rounded-[32px] bg-white/60 dark:bg-slate-900/40 border border-slate-200/50 dark:border-white/5 space-y-4 shadow-sm group hover:shadow-md transition-all">
                            ...
                            <button 
                                ...
                                className="w-full py-2.5 rounded-xl bg-slate-50 dark:bg-slate-800 text-[10px] font-black uppercase tracking-widest text-slate-400 group-hover:bg-primary group-hover:text-white transition-all"
                            >
                                Open Sessions
                            </button>
                        </div>
